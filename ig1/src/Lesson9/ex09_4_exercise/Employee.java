...
/**
 * Employee class representing an employee's details and supporting builder pattern for construction.
 */
public class Employee {
  // Employee personal and job-related fields
  ...
  /**
   * Builder class to construct Employee objects with optional parameters.
   */
  ...
  /**
   * Prints detailed employee info to standard output.
   */
  public void print(){
    System.out.println(
            "\nName: " + givenName + " " + surName + " -- " +
  ...
  /**
   * Prints a short summary of employee info.
   */
  ...
  /**
   * Creates and returns a sample list of Employee objects.
   * @return List<Employee> sample employees
   */
