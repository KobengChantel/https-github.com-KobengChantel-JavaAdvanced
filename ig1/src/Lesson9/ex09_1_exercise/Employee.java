...
// This class models an Employee with personal and job-related details and uses the Builder pattern to construct Employee instances.
...
public class Employee {
  ...
  // Static inner Builder class for constructing Employee objects
  public static class Builder {
    ...
    // Builder methods for setting each field, returning the Builder object for chaining
  ...
  // Prints the full string representation to the console
  public void print() {
    System.out.println(toString());
  }

  // Returns a short summary string of key employee info
  ...
  // Creates a hard-coded list of sample employees
  public static List<Employee> createShortList() {
    List<Employee> people = new ArrayList<>();

    // Add several Employee instances using the Builder
    people.add(
            new Builder()
                    .givenName("Bob")
                    .surName("Baker")
